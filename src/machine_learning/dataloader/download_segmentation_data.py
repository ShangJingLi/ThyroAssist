...
def download_and_unzip_unet_checkpoints():
    openi.download_file(repo_id="enter/nodule_segmentation", file="unet_checkpoints.zip", cluster="NPU",
                        save_path=download_dir,
                        force=False)
    zip_file_path = os.path.join(download_dir, 'unet_checkpoints.zip')
...
def download_unet_om():
    openi.download_model(repo_id="enter/nodule_segmentation",
                         model_name="unet",save_path=download_dir)
...
def download_nested_unet_om():
    openi.download_model(repo_id="enter/nodule_segmentation",
                         model_name="nested_unet",save_path=download_dir)
...
def download_ultrasound_images():
    openi.download_file(repo_id="enter/nodule_segmentation", file="ultrasound_images_to_show.zip", cluster="NPU",
                        save_path=download_dir,
                        force=False)
    zip_file_path = os.path.join(download_dir, 'ultrasound_images_to_show.zip')
