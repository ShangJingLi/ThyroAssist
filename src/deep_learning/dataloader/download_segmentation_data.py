...
def download_and_unzip_segmentation_checkpoints():
    openi.download_file(repo_id="enter/nodule_segmentation", file="segmentation_checkpoints.zip", cluster="NPU",
                        save_path=".",
                        force=False)
    zip_file_path = 'segmentation_checkpoints.zip'
