...
# 4. 保存模型
def save_model(model, scaler, model_filename="judge_solidity_model.pkl", scaler_filename="judge_solidity_scaler.pkl"):
...
if __name__ == "__main__":
    image_dir = "judge_solidity_datasets"  # 数据集目录路径
    label_map = {0: 'solidity', 1: 'cystic'}  # 标签映射:0表示实性，1表示囊性
