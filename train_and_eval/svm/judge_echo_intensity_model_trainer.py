...
# 4. 保存模型
def save_model(model, scaler, model_filename="judge_echo_intensity_model.pkl",
               scaler_filename="judge_echo_intensity_scaler.pkl"):
...
if __name__ == "__main__":
    image_dir = "judge_echo_intensity_datasets"  # 数据集目录路径
    label_map = {0: 'weak', 1: 'not weak'}  # 标签映射:0表示弱回声，1表示非弱回声
